...
$(document).ready(function () {
    var records;
    var urlRecordList = siteUrl + "admin/news/getCategoryList";
    var urlDelete = siteUrl + "admin/news/category/delete";
    var urlRecordPublish = siteUrl + "admin/news/updateNewsCatStatus";
    var urlRecordEdit = siteUrl + "admin/news/category/edit";
