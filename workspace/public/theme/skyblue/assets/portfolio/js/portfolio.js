...
function validataPortfolioForm() {
    var name = $('#name').val();
...
$(document).ready(function () {
    var records;
    var urlRecordList = siteUrl + "admin/portfolio/getList";
    var urlDelete = siteUrl + "admin/portfolio/delete";
    var urlRecordPublish = siteUrl + "admin/portfolio/updatePortfolioStatus";
    var urlRecordEdit = siteUrl + "admin/portfolio/edit";
