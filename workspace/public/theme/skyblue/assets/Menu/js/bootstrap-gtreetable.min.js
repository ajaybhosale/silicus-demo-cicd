(function ($) {
    ...
    function GTreeTable(element, options) {
      ...
      var cusInputField = '<label class="strong">Menu Name:</label> <input type="text" name="name" value="" style="width:20%;" class="form-control" />';
          cusInputField +='<label class="strong">Url : </label> <input type="text" name="link" value="" style="width:20%;" class="form-control" />';
          cusInputField +='<label class="strong">Login Required : </label> <input type="checkbox" name="req-login" style="width:2%;height:19px;" class="form-control" value="1" />';
    ...
    GTreeTableNode.prototype = {
        ...
        init: function () {
            ...
            this.$input = this.$node.find('input[name="name"]');      
        ...
        showForm: function (action) {
            if (action === true) {
                ...
                if(this.link!=link && link!=''){
                   this.$input.closest('span.node-action').find('input[name="link"]').val(link);
                }else{
                   this.$input.closest('span.node-action').find('input[name="link"]').val(this.link);
                }
                
                if(this.req_login==1){
                   this.$input.closest('span.node-action').find('input[name="req-login"]').attr('CHECKED','CHECKED');
                }else{
                   this.$input.closest('span.node-action').find('input[name="req-login"]').removeAttr('CHECKED');
                }
