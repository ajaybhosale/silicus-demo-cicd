...
<html lang="en">
    ...
    <body class="homepage">
        ...
        <script src="{{$url}}/theme/{{$theme}}/js/jquery.prettyPhoto.js"></script>
        <script src="{{$url}}/theme/{{$theme}}/js/jquery.isotope.min.js"></script>
        <script src="{{$url}}/theme/{{$theme}}/js/main.js"></script>
        <script src="{{$url}}/theme/{{$theme}}/js/wow.min.js"></script>
        ...
        <script>
            function setWindowHeight() {
                ...
                $(".mainblock").css("min-height", setHeight);
            }
